...
function enviarCorreoCoordinacion($emailCoordinacion, $nombreAprendiz, $documentoAprendiz, $programaAprendiz, $fichaAprendiz, $jornadaAprendiz, $nombreInstructor, $documentoInstructor, $descripcionAprendiz) {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->CharSet = 'UTF-8';
        $mail->Subject = 'Aviso de Solicitud Aprobada para Coordinación';
        ...
        <body>
            <div class="email-wrapper">
                <div class="email-container">
                    ...
                    <div class="content">
                        <div class="greeting">Estimada Coordinación Académica,</div>
                        
                        <p>Se notifica que el aprendiz <strong>$nombreAprendiz</strong>, documento <strong>$documentoAprendiz</strong>, del programa de formación <strong>$programaAprendiz</strong>, ficha <strong>$fichaAprendiz</strong>, jornada <strong>$jornadaAprendiz</strong>, ha registrado una solicitud de salida que fue aprobada por el instructor(a) <strong>$nombreInstructor</strong> (Documento: $documentoInstructor).</p>

                        <div class="info-box">
                            <strong>Detalle/Motivo indicado por el aprendiz:</strong><br>
                            $descripcionAprendiz
                        </div>

                        <p>Por favor, continuar con el trámite correspondiente desde la plataforma Sicss SENA.</p>
...
HTML;
        ...
        $mail->send();
        file_put_contents($logFile, date('Y-m-d H:i:s') . " [SUCCESS] Correo enviado a coordinación $emailCoordinacion\n", FILE_APPEND);
        return true;
