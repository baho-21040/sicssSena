...
export default function Estado() {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${API_URL}/api/coordinacion/usuarios?q=${documento}`, {
                headers: {
    ...
    const submitStatusChange = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`${API_URL}/api/coordinacion/usuarios/${usuarioSeleccionado.id_usuario}/estado`, {
                method: 'PUT',
                headers: {
            ...
            <div className="min-h-screen bg-gray-50 p-8 pt-24">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-xl shadow-lg p-8 relative">
                        <Link to="/coordinacion/inicio" className="absolute top-8 left-8 text-gray-500 hover:text-gray-700 flex items-center transition">
